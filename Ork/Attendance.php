...
class Attendance extends Ork3
{
    ...
    public function GetClasses( $request )
    {
        ...
        $response = [ 'Status' => Success(), 'Classes' => [ ] ];
    ...
    public function AddAttendance( $request )
    {
        ...
        switch ( $type ) {
            case AUTH_PARK:
                $park = Ork3::$Lib->park->GetParkShortInfo( [ 'ParkId' => $request[ 'ParkId' ] ] );
            ...
            case AUTH_KINGDOM:
                ...
                break;
            case AUTH_EVENT:
                $detail = Ork3::$Lib->event->GetEventDetail( [ 'EventCalendarDetailId' => $request[ 'EventCalendarDetailId' ] ] );
        ...
        logtrace( "Attendance->AddAttendance()", [ $this->attendance->lastSql(), $request, $detail ] );
    ...
    public function SetAttendance( $request )
    {
        ...
        logtrace( "Attendance->AddAttendance()", [ $this->attendance->lastSql() ] );
    ...
    public function AttendanceAuthority( $request )
    {
        ...
        if ( valid_id( $request[ 'AttendanceId' ] ) ) {
            ...
            if ( $this->attendance->find() ) {
                return $this->attendance_authority_h( [ 'Token' => $request[ 'Token' ], 'ParkId' => $this->attendance->park_id, 'KingdomId' => $this->attendance->kingdom_id, 'EventId' => $this->attendance->event_id ] );
            } else {
                return false;
            }
        } else {
