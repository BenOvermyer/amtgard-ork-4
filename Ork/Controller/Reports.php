...
class Reports extends Controller
{
	...
	public function __construct( $call = null, $method = null )
	{
		...
		$this->data[ 'menu' ][ 'reports' ] = [ 'url' => UIR . 'Reports', 'display' => 'Reports' ];
	}
	...
	function parkheraldry( $kingdom_id = null )
	{
		...
		$this->data[ 'Heraldry' ] = $this->Reports->get_heraldry_report( [
			'Type'      => 'Park',
	...
	public function guilds( $param = null )
	{
		...
		$this->data[ 'Guilds' ] = $this->Reports->guilds( [ 'KingdomId' => 'Kingdom' == $type ? $id : 0, 'ParkId' => 'Park' == $type ? $id : 0, 'ReportFromDate' => date( 'Y-m-d' ), 'PerMonths' => 1, 'Periods' => 6, 'MinimumAttendanceRequirement' => 1 ] );
	}
	...
	public function player_awards( $params = null )
	{
		...
		$this->data[ 'Awards' ] = $this->Reports->kingdom_awards( [ 'KingdomId' => 'Kingdom' == $type ? $id : 0, 'ParkId' => 'Park' == $type ? $id : 0, 'IncludeKnights' => 1, 'IncludeMasters' => 1, 'IncludeLadder' => 1, 'LadderMinimum' => $ladder ] );
	}
	...
	public function knights_and_masters( $params = null )
	{
		...
		$this->data[ 'Awards' ] = $this->Reports->kingdom_awards( [ 'KingdomId' => 'Kingdom' == $type ? $id : 0, 'ParkId' => 'Park' == $type ? $id : 0, 'IncludeKnights' => 1, 'IncludeMasters' => 1 ] );
	}
