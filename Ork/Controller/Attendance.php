...
class Attendance extends Controller
{
	...
	public function __construct( $call = null, $id = null )
	{
		...
		$params = explode( '/', $id );
		$id = $params[ 0 ];
		$this->data[ 'menu' ][ 'attendance' ] = [ 'url' => UIR . "Attendance/$call/$id", 'display' => 'Attendance' ];
	...
	public function kingdom( $k )
	{
		...
		logtrace( 'Attendance->park()', [ $params, $id, $this->request, $this->request->Attendance_kingdom->AttendanceDate ] );
	...
	public function park( $p )
	{
		...
		logtrace( 'Attendance->park()', [ $params, $id, $this->request, $this->request->Attendance_park->AttendanceDate ] );
	...
	public function event( $p )
	{
		...
		logtrace( 'Attendance->event()', [ $params, $this->request ] );
