...
class Principality extends Controller
{
	...
	public function __construct( $call = null, $id = null )
	{
		...
		$this->data[ 'menu' ][ 'principality' ] = [ 'url' => UIR . 'Principality/index/' . $this->session->principality_id, 'display' => $this->session->principality_name ];
		$this->data[ 'menulist' ][ 'admin' ] = [
			[ 'url' => UIR . 'Admin/kingdom/' . $this->session->kingdom_id, 'display' => 'Principality' ],
		];
